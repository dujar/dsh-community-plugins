  ...
  factory: (require) => {
    ...
    function RepoActions(props) {
      ...
      if (installed) {
        ...
        primary = createElement('button', { type: 'button', onClick: function () { props.onInstall(repo) }, style: primaryStyle }, t('install'))
      }
      ...
      function onInstall(repo) {
        ...
        api.install(repo).then(function (res) {
          ...
          if (res && res.ok) {
            ...
            setNotice({ kind: 'err', text: t('installFailed'), detail: (res && res.error) || (res && res.output) || '' })
          }
        }).catch(function (e) {
          setBusy(null)
      ...
      function onUninstall(repo) {
        ...
        api.uninstall(repo).then(function (res) {
          ...
          if (res && res.ok) {
            ...
            setNotice({ kind: 'err', text: t('uninstallFailed'), detail: (res && res.error) || (res && res.output) || '' })
          }
        }).catch(function (e) {
          setBusy(null)
